...
class InternalClock:
    ...
    def find_dayname(self):
        ...
        self.dayname = [locales.get_substring("system", day) for day in ["day_0", "day_1", "day_2", "day_3", "day_4", "day_5", "day_6"]][self.weekday]
    ...
    def update(self):
        if not self.game.menu_manager.sidemenu.onscreen:        # Pas d'update lorsque le menu latéral est ouvert
            ...
            # Evénements cadencés aux self.MINUTES_PER_TURN minutes
